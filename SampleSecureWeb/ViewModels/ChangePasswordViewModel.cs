...
namespace SampleSecureWeb.ViewModels
{
    public class ChangePasswordViewModel
    {
        ...
        public string? CurrentPassword { get; set; }  // Jadikan nullable
        ...
        [DataType(DataType.Password)]
        public string? NewPassword { get; set; }  // Jadikan nullable

        [Required]
        [Compare("NewPassword", ErrorMessage = "Kata sandi tidak cocok.")]
        [DataType(DataType.Password)]
        public string? ConfirmNewPassword { get; set; }  // Jadikan nullable
    }
}
